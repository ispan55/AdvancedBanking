...
//_player setVariable ["ExileMoney", (_data select 38)]; //BANKING: Remove line
...
[
	...
	[
		(netId _player),
		str (_player getVariable ["ExileClientPlayerMoney", 0]), //BANKING: Changed to ExileClientPlayerMoney
