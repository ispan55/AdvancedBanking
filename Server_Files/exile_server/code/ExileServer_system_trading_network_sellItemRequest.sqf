...
try
{
	...
	_playerMoney = _playerObject getVariable ["ExileClientPlayerMoney", 0]; // BANKING: Changed to ExileClientPlayerMoney
	_playerMoney = _playerMoney + _sellPrice;
	_playerObject setVariable ["ExileClientPlayerMoney", _playerMoney]; // BANKING: Changed to ExileClientPlayerMoney
